    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">BIZCA</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/addresseses">
            <ListItem button key="Addresses">
              ...
              <ListItemText className="menu-text" primary="Addresses" />
            </ListItem>
          </Link>{" "}            
           <Link to="/manage-clients">
            <ListItem button key="Manage Clients">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Manage Clients" />
            </ListItem>
          </Link>{" "}            
           <Link to="/users">
